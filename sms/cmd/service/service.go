...
import (
	...
	http "github.com/king19800105/feigo/sms/pkg/http"
...
var fs = flag.NewFlagSet("sms", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "sms")
